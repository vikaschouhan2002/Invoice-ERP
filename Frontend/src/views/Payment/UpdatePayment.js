        ...
        <Card>
            <Grid container spacing={2} style={{ marginBottom: "20px" }}>
                <Grid item style={{ display: 'flex', justifyContent: "space-between", alignItems: "flex-start" }}>
                    ...
                    <Typography style={{ margin: "9px", marginLeft: "-15px" }} variant='h5'>Update Payment # 1/2024
                    </Typography>
                ...
                <Grid item xs={12} md={8} lg={8} style={{ display: 'flex', justifyContent: "end", alignItems: "end", textAlign: "end", }}>
                    <Button onClick={() => { navigate("/dashboard/payment") }} style={{ margin: "5px", color: "black", borderColor: "black", }} variant='outlined'><AiOutlineCloseCircle style={{ margin: '3px', marginLeft: "-3px" }} /> Cancel</Button>
            ...
            <Grid container spacing={2} style={{ margin: "10px" }} >
                ...
                <Grid xs={12} md={6} lg={6}>
                    <Grid container style={{ display: "flex", justifyContent: "center", alignItems: "center" }}>
                        ...
                        <Grid item xs={12} md={10} lg={10} style={{ padding: "10px" }}>
                            <Typography variant='h5'>Balance: 5.75</Typography>
                        </Grid>
