...
const Admin = () => {
    ...
    const fetchData = async()=>{
        try{
            const response = await getDataAPI("admin","getAdmindata");
    ...
    return (
        <>
            <AdminDrawer handleClickOpen={handleClickOpen} handleSetMode={handleSetMode} fetchData={fetchData} open={openAdd} setRowData={setRowData} handleClose={handleCloseAdd} mode={mode} data={rowData} />
            <Container>
                                    ...
                                    <TableBody>
                                        ...
                                        return (
                                            ...
                                            <StyledTableCell align='center'>
                                                <Image src={`${backendURL}/public/uploads/${row.Profile}`} width={100}></Image>
                                            </StyledTableCell>                                
                                            <StyledTableCell align='center'><Switch defaultChecked={row.Enabled}/></StyledTableCell>                                
                                            <StyledTableCell align='center'>                                                
                                                <ActionsPopover c_role="Admin" row={row} handleSetMode={handleSetMode} setRowData={setRowData} handleClickOpen={handleClickOpen} handleOpenAdd={handleOpenAdd} />
                                            </StyledTableCell>
                                            </StyledTableRow>
                                        );
                                        })}
            ...
            >
                ...
                <DialogActions>
                    ...
                    <Button variant='contained' onClick={()=>{deleteData(); handleCloseDialog()}} autoFocus>
                        OK
                    </Button>
                </DialogActions>
            </Dialog>
...
{/* <IconButton variant='outlined' style={{margin:'5px',fontSize:'10px',borderRadius:'50%', color:"black"}} onClick={()=>{ console.log("rows in cell ====> : ",row); handleOpenAdd(); handleSetMode('show'); setRowData(row);}}><VisibilityIcon/></IconButton>
<IconButton variant='outlined' style={{margin:'5px',fontSize:'10px',borderRadius:'50%', color:"black"}} onClick={()=>{ handleOpenAdd(); handleSetMode('edit'); setRowData(row); }}><EditIcon/></IconButton>
<IconButton variant='outlined' style={{margin:'5px',fontSize:'10px',borderRadius:'50%', color:"black"}} onClick={()=>{ setRowData(row); handleClickOpen(); }}><DeleteIcon/></IconButton> */}