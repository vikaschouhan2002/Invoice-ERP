    ...
    const formik = useFormik({
        ...
        onSubmit: async (values) => {
            try {
                ...
                if (mode === "add") {
                    const result = await axios.post(`${backendURL}/productcategory/addNewCategory`, values);
                ...
                <React.Fragment key={anchor}>
                    ...
                    >
                        <Grid style={{ display: "flex", justifyContent: "start", margin: '10px' }}>
                            ...
                            <Typography variant='h2' style={{ marginLeft: '10px' }}> Product Category </Typography>
                        </Grid>
                        ...
                        {mode === "edit" ? <Box>
                            <Typography variant='h2' style={{ padding: '10px', textAlign: 'center', color: '#008DFF' }}> EDIT PRODUCT CATEGORY </Typography>
                            <Divider orientation='horizontal' />
                            <form method='post' onSubmit={formik.handleSubmit}>
                                <Grid style={{ display: "flex", justifyContent: "start", width: "100%", marginTop: '15px', padding: "10px", paddingBottom: '0px' }}>
                                    <FormControl fullWidth style={{ margin: "10px" }}>
